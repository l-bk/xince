...
public class XcTestInfo {
    ...
    private String testPreferentialPrice;
    private String testReportLength;
    ...
    public String getTestPreferentialPrice() {
        return testPreferentialPrice;
    }

    public void setTestPreferentialPrice(String testPreferentialPrice) {
